...
interface ProductCardProps {
	...
	sku: string;
	urlKey: string;
	openViewProduct: (value:any) => void;
}
					...
					>
						...
						>
							<div
								className={`${
									isGrid
										? "flex flex-col items-start px-2 w-full"
										: "mt-5"
								} `}
							>
          ...
          >
			...
			>
				...
				>
					...
					<div className="mt-2">
						<Link to={`/product-page/${urlKey}`} reloadDocument>
							<p
								className={`text-sm font-[200] mb-1  text-start font-OG-Medium text-lightTextColor line-clamp-2`}
							>
								{name}
							</p>
							{ratingCount > 0 && (
